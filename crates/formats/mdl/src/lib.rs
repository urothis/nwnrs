...
pub mod prelude {
    pub use crate::{
        ...
        UnknownBinaryBlock, UnresolvedTexture, Vec3Key, Vec4Key, detect_model_encoding,
        lower_ascii_model, lower_semantic_model_to_scene, parse_ascii_model,
        parse_binary_model_bytes, parse_model_bytes, parse_scene_model, parse_scene_model_auto,
        parse_semantic_model, parse_semantic_model_auto, read_ascii_model,
        read_ascii_model_from_file, read_ascii_model_from_res, read_binary_model,
        read_binary_model_from_file, read_binary_model_from_res, read_model, read_model_from_file,
        read_model_from_res, read_parsed_model, read_parsed_model_from_file,
        read_parsed_model_from_res, read_scene_model, read_scene_model_auto,
        read_scene_model_auto_from_file, read_scene_model_auto_from_res,
        read_scene_model_from_file, read_scene_model_from_res, read_semantic_model,
        read_semantic_model_auto, read_semantic_model_auto_from_file,
