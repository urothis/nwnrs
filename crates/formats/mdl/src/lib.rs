...
pub mod prelude {
    pub use crate::{
        ...
        read_semantic_model_auto, resolve_material_textures, resolve_scene_texture_ref,
        resolve_scene_texture_ref_with_policy, resolve_scene_textures, resolve_texture_ref,
        scene_texture_resolution_names, write_ascii_model, write_binary_model, write_model,
        write_parsed_model, write_scene_model, write_semantic_model,
    };
}
