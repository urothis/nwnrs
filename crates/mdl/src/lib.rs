...
pub mod prelude {
    pub use crate::{
        ...
        SemanticUvLayer, TextureResolverOptions, TextureResourceKind, UnknownBinaryBlock,
        UnresolvedTexture, Vec3Key, Vec4Key, detect_model_encoding, lower_ascii_model,
        ...
        read_semantic_model_from_res, resolve_material_textures, resolve_scene_textures,
        resolve_texture_ref, write_ascii_model, write_model,
    };
}
